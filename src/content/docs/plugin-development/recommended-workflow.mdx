...
:::note
The cornerstone of this workflow is the DEV_PLUGIN feature of Re:Earth Visualizer, which enables loading plugins directly from a local development server. While the provided plugin template is a convenient starting point, it is not mandatory. You are free to create your plugin project using any framework or library of your choice. Additionally, we plan to offer more templates in the future to cater to diverse development preferences.
:::

## Create New Plugin using Template

For now we recommend using this <a href="https://github.com/reearth-plugins/reearth-visualizer-plugin-shadcn-template" target="_blank">Re:Earth Visualizer Plugin ShadCN Template</a>.
